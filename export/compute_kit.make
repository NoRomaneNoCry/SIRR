...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/compute_kit
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/compute_kit
...
ifeq ($(config),release)
  OBJDIR     = obj/release/compute_kit
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/compute_kit
...
$(OBJDIR)/nvFont.o: gKit/Widgets/nvFont.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/compute_kit.o: compute_kit.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
