...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/tp1sphere_reyes
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/tp1sphere_reyes
...
ifeq ($(config),release)
  OBJDIR     = obj/release/tp1sphere_reyes
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/tp1sphere_reyes
...
ifeq ($(config),gprof)
  OBJDIR     = obj/gprof/tp1sphere_reyes
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/tp1sphere_reyes
  DEFINES   += -DGK_OPENGL4 -DVERBOSE
  INCLUDES  += -I. -IgKit
...
$(OBJDIR)/nvFont.o: gKit/Widgets/nvFont.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/tp1sphere_reyes.o: tp1sphere_reyes.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
