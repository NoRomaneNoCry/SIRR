...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/filter_tutorial1
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/filter_tutorial1
...
ifeq ($(config),release)
  OBJDIR     = obj/release/filter_tutorial1
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/filter_tutorial1
...
ifeq ($(config),gprof)
  OBJDIR     = obj/gprof/filter_tutorial1
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/filter_tutorial1
  DEFINES   += -DGK_OPENGL4 -DVERBOSE
  INCLUDES  += -I. -IgKit
...
clean:
	@echo Cleaning filter_tutorial1
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/nvFont.o: gKit/Widgets/nvFont.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/filter_tutorial1.o: filter_tutorial1.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
