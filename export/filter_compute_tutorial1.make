...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/filter_compute_tutorial1
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/filter_compute_tutorial1
...
ifeq ($(config),release)
  OBJDIR     = obj/release/filter_compute_tutorial1
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/filter_compute_tutorial1
...
ifeq ($(config),gprof)
  OBJDIR     = obj/gprof/filter_compute_tutorial1
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/filter_compute_tutorial1
  DEFINES   += -DGK_OPENGL4 -DVERBOSE
  INCLUDES  += -I. -IgKit
...
OBJECTS := \
	...
	$(OBJDIR)/nvPainter.o \
	$(OBJDIR)/nvFont.o \
	$(OBJDIR)/filter_compute_tutorial1.o \
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking filter_compute_tutorial1
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning filter_compute_tutorial1
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/nvFont.o: gKit/Widgets/nvFont.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/filter_compute_tutorial1.o: filter_compute_tutorial1.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
