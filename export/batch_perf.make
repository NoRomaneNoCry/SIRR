...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/batch_perf
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/batch_perf
...
$(OBJDIR)/nvFont.o: gKit/Widgets/nvFont.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/batch_perf.o: batch_perf.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
