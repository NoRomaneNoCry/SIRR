...
ifeq ($(config),debug)
  OBJDIR     = obj/debug/tessellation_sphere
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/tessellation_sphere
...
ifeq ($(config),release)
  OBJDIR     = obj/release/tessellation_sphere
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/tessellation_sphere
...
ifeq ($(config),gprof)
  OBJDIR     = obj/gprof/tessellation_sphere
  TARGETDIR  = .
  TARGET     = $(TARGETDIR)/tessellation_sphere
  DEFINES   += -DGK_OPENGL4 -DVERBOSE
  INCLUDES  += -I. -IgKit
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking tessellation_sphere
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning tessellation_sphere
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/nvFont.o: gKit/Widgets/nvFont.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/tessellation_sphere.o: tessellation_sphere.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
